...
import { analyticsRoutes } from '@/features/analytics/router';
import { projectRoutes } from '@/features/projects/router';
import { taskAction, taskRoutes } from '@/features/tasks/router';
...
export const protectedRoutes: RouteObject[] = [...taskRoutes, ...projectRoutes, ...analyticsRoutes];
